...
export const MessageEmail = ({
  ...
  const t = getEmailStrings(locale).message;
  return (
    <Html>
      <Head />
      <Preview>{t.preview(senderName)}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>{t.body(senderName)}</Text>
            ...
            <Text style={paragraph}>{t.footerNote}</Text>
          </Section>
